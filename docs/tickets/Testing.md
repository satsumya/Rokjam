...
In **production mode** with Supabase env vars set, **auth, profile, sessions, and community** use Supabase adapters. Prototype mode and QA tooling continue to use mock data.
